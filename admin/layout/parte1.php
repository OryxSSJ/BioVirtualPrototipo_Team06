...
if (($rol_sesion_usuario == "ESTUDIANTE") || ($rol_sesion_usuario == "ADMINISTRADOR")) { ?>
                        <li class="nav-item">
                        <a href="#" class="nav-link active">
                            <i class="nav-icon fas"><i class="bi bi-robot"></i></i>
                            <p>
                                Asistente IA
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= APP_URL; ?>/admin/asistente" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Consulta IA</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link active">
                            <i class="nav-icon fas"><i class="bi bi-backpack4"></i></i>
                            <p>
                                Classroom
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= APP_URL; ?>/admin/estudiantes/materias.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Clases</p>
                                </a>
                            </li>
