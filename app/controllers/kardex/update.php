...
if($sentencia->execute()){
    echo 'success';
    session_start();
    $_SESSION['mensaje'] = "Se actualizo el reporte de la manera correcta en la base de datos";
...
//header('Location:' .$URL.'/');
    ...
    session_start();
    $_SESSION['mensaje'] = "Error no se pudo actualizo en la base datos, comuniquese con el administrador";
