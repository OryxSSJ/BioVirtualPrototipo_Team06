...
// Defect 1030: Módulo de cobros no desplegado (Simulación de estado Bloqueado)
$modulo_desplegado = false; 
if (!$modulo_desplegado) {
    session_start();
    $_SESSION['mensaje'] = "Módulo de cobros no desplegado. Contacte a soporte técnico. (Defecto 1030)";
