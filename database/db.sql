...
INSERT INTO roles (nombre_rol,fyh_creacion,estado) VALUES  ('ADMINISTRADOR','2026-03-11 17:05:00','1');
...
VALUES ('1','Carlos Andrei Saucedo Aguilar','admin@admin.com','$2y$10$0tYmdHU9uGCIxY1f90W1EuIm54NQ8axowkxL1WzLbqO2LdNa8m3l2','2026-03-11 17:05:00','1');
...
VALUES ('1','Carlos Andrei','Saucedo Aguilar','12345678','10/08/2001','INGENIERO INFORMATICO','Zona Los Pinos Av. Las Rosas Nro 100','75657007','2026-03-11 17:05:00','1');
...
VALUES ('1','SECUNDARIA','MAÑANA','2023-12-28 20:29:10','1');
...
VALUES ('1','SECUNDARIA - 1','A','2023-12-28 20:29:10','1');
...
CREATE TABLE publicaciones (
  ...
  tipo ENUM('ANUNCIO','TAREA') DEFAULT 'ANUNCIO',
  fecha_publicacion DATETIME DEFAULT CURRENT_TIMESTAMP,
  fecha_entrega DATETIME NULL,
  estado TINYINT(1) DEFAULT 1,
  FOREIGN KEY (docente_id) REFERENCES docentes(id_docente) ON DELETE CASCADE,
  FOREIGN KEY (materia_id) REFERENCES materias(id_materia) ON DELETE SET NULL,
  FOREIGN KEY (nivel_id) REFERENCES niveles(id_nivel) ON DELETE SET NULL,
  FOREIGN KEY (grado_id) REFERENCES grados(id_grado) ON DELETE SET NULL
) ENGINE=InnoDB;

CREATE TABLE envios_publicacion (
  ...
  estado TINYINT(1) DEFAULT 1,
  FOREIGN KEY (publicacion_id) REFERENCES publicaciones(id_publicacion) ON DELETE CASCADE,
